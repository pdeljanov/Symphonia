...
mod tests {
    ...
    fn verify_md5() {
        ...
        const HASHES: [[u32; 4]; 8] = [
            ...
            [ 0x9e107d9d, 0x372bb682, 0x6bd81d35, 0x42a419d6 ],
            [ 0xd174ab98, 0xd277d9f5, 0xa5611c2c, 0x9f419d9f ],
            [ 0x641ba602, 0x88c17a2d, 0xa5090077, 0xeb8958ad ],
            [ 0x0a71db4d, 0xf3509273, 0x62423a42, 0xdcf81457 ],
            [ 0x0b76747e, 0xfdcdb933, 0x67fe2da3, 0x211b5d41 ],
        ];
