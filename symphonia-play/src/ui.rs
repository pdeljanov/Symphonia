...
fn fmt_tag(tag: &Tag) -> FormattedTag<'_> {
    ...
    match std_tag {
        ...
        StandardTag::Actor(v) => FormattedTag::new("Actor", &**v),
        ...
        StandardTag::ArtDirector(v) => FormattedTag::new("Art Directory", &**v),
        StandardTag::Artist(v) => FormattedTag::new("Artist", &**v),
        StandardTag::AssistantDirector(v) => FormattedTag::new("Assisstant Director", &**v),
        ...
        StandardTag::CdTrackIndex(v) => FormattedTag::new("CD Track Index", v.to_string()),
        StandardTag::ChapterTitle(v) => FormattedTag::new("Chapter Title", &**v),
        StandardTag::Choregrapher(v) => FormattedTag::new("Choregrapher", &**v),
        StandardTag::Cinematographer(v) => FormattedTag::new("Cinematographer", &**v),
        StandardTag::CollectionTitle(v) => FormattedTag::new("Collection", &**v),
        ...
        StandardTag::ContentRating(v) => FormattedTag::new("Content Rating", &**v),
        StandardTag::ContentType(v) => FormattedTag::new("Content Type", &**v),
        StandardTag::Coproducer(v) => FormattedTag::new("Coproducer", &**v),
        StandardTag::Copyright(v) => FormattedTag::new("Copyright", &**v),
        StandardTag::CostumeDesigner(v) => FormattedTag::new("CostumeDesigner", &**v),
        ...
        StandardTag::DigitizedDate(v) => FormattedTag::new("Digitization Date", &**v),
        StandardTag::Director(v) => FormattedTag::new("Director", &**v),
        ...
        StandardTag::Distributor(v) => FormattedTag::new("Distributor", &**v),
        StandardTag::EditedBy(v) => FormattedTag::new("Edited By", &**v),
        StandardTag::EditionTitle(v) => FormattedTag::new("Edition", &**v),
        ...
        StandardTag::ExecutiveProducer(v) => FormattedTag::new("Executive Producer", &**v),
        ...
        StandardTag::IdentLccn(v) => FormattedTag::new("LCCN", &**v),
        ...
        StandardTag::ImdbTitleId(v) => FormattedTag::new("IMDB Title ID", &**v),
        ...
        StandardTag::Keywords(v) => FormattedTag::new("Keywords", &**v),
        ...
        StandardTag::Measure(v) => FormattedTag::new("Measure", &**v),
        ...
        StandardTag::MovieTitle(v) => FormattedTag::new("Movie", &**v),
        ...
        StandardTag::OpusNumber(v) => FormattedTag::new("Opus Number", v.to_string()),
        ...
        StandardTag::OriginalRecordingDate(v) => FormattedTag::new("Original Recording Date", &**v),
        StandardTag::OriginalRecordingTime(v) => FormattedTag::new("Original Recording Time", &**v),
        StandardTag::OriginalRecordingYear(v) => {
            FormattedTag::new("Original Recording Year", v.to_string())
        }
        StandardTag::OriginalReleaseDate(v) => FormattedTag::new("Original Release Date", &**v),
        StandardTag::OriginalReleaseTime(v) => FormattedTag::new("Original Release Time", &**v),
        StandardTag::OriginalReleaseYear(v) => {
            FormattedTag::new("Original Release Year", v.to_string())
        }
        ...
        StandardTag::PartNumber(v) => FormattedTag::new("Part Number", v.to_string()),
        StandardTag::PartTitle(v) => FormattedTag::new("Part", &**v),
        StandardTag::PartTotal(v) => FormattedTag::new("Part Total", v.to_string()),
        StandardTag::Performer(v) => FormattedTag::new("Performer", &**v),
        StandardTag::Period(v) => FormattedTag::new("Period", &**v),
        ...
        StandardTag::ProductionDesigner(v) => FormattedTag::new("Production Designer", &**v),
        StandardTag::ProductionStudio(v) => FormattedTag::new("Production Studio", &**v),
        StandardTag::PurchaseDate(v) => FormattedTag::new("Purchase Date", &**v),
        StandardTag::Rating(v) => FormattedTag::new("Rating", v.to_string()),
        ...
        StandardTag::RecordingYear(v) => FormattedTag::new("Recording Year", v.to_string()),
        StandardTag::ReleaseCountry(v) => FormattedTag::new("Release Country", &**v),
        StandardTag::ReleaseDate(v) => FormattedTag::new("Release Date", &**v),
        StandardTag::ReleaseTime(v) => FormattedTag::new("Release Time", &**v),
        StandardTag::ReleaseYear(v) => FormattedTag::new("Release Year", v.to_string()),
        ...
        StandardTag::ScreenplayAuthor(v) => FormattedTag::new("Screenplay Author", &**v),
        ...
        StandardTag::SortCollectionTitle(v) => FormattedTag::new("Collection (Sort Order)", &**v),
        StandardTag::SortComposer(v) => FormattedTag::new("Composer (Sort Order)", &**v),
        StandardTag::SortEditionTitle(v) => FormattedTag::new("Edition (Sort Order)", &**v),
        StandardTag::SortMovieTitle(v) => FormattedTag::new("Movie (Sort Order)", &**v),
        StandardTag::SortOpusTitle(v) => FormattedTag::new("Opus (Sort Order)", &**v),
        StandardTag::SortPartTitle(v) => FormattedTag::new("Part (Sort Order)", &**v),
        StandardTag::SortTrackTitle(v) => FormattedTag::new("Track Title (Sort Order)", &**v),
        StandardTag::SortTvSeriesTitle(v) => FormattedTag::new("TV Series (Sort Order)", &**v),
        StandardTag::SortVolumeTitle(v) => FormattedTag::new("Volume (Sort Order)", &**v),
        StandardTag::Subject(v) => FormattedTag::new("Subject", &**v),
        StandardTag::Summary(v) => FormattedTag::new("Summary", &**v),
        StandardTag::Synopsis(v) => FormattedTag::new("Synopsis", &**v),
        StandardTag::TaggingDate(v) => FormattedTag::new("Tagging Date", &**v),
        StandardTag::TermsOfUse(v) => FormattedTag::new("Terms of Use", &**v),
        StandardTag::Thanks(v) => FormattedTag::new("Thanks", &**v),
        StandardTag::TmdbMovieId(v) => FormattedTag::new("TMDB Movie ID", &**v),
        StandardTag::TmdbSeriesId(v) => FormattedTag::new("TMDB Series ID", &**v),
        ...
        StandardTag::Tuning(v) => FormattedTag::new("Tuning", &**v),
        StandardTag::TvdbEpisodeId(v) => FormattedTag::new("The TVDB Episode ID", &**v),
        StandardTag::TvdbMovieId(v) => FormattedTag::new("The TVDB Movie ID", &**v),
        StandardTag::TvdbSeriesId(v) => FormattedTag::new("The TVDB Series ID", &**v),
        StandardTag::TvEpisodeNumber(v) => FormattedTag::new("TV Episode Number", v.to_string()),
        StandardTag::TvEpisodeTitle(v) => FormattedTag::new("TV Episode", &**v),
        StandardTag::TvEpisodeTotal(v) => FormattedTag::new("TV Episode Total", v.to_string()),
        StandardTag::TvNetwork(v) => FormattedTag::new("TV Network", &**v),
        StandardTag::TvSeasonNumber(v) => FormattedTag::new("TV Season Number", v.to_string()),
        StandardTag::TvSeasonTitle(v) => FormattedTag::new("TV Season", &**v),
        StandardTag::TvSeasonTotal(v) => FormattedTag::new("TV Season Total", v.to_string()),
        StandardTag::TvSeriesTitle(v) => FormattedTag::new("TV Series", &**v),
        ...
        StandardTag::VolumeNumber(v) => FormattedTag::new("Volume Number", v.to_string()),
        StandardTag::VolumeTitle(v) => FormattedTag::new("Volume", &**v),
        StandardTag::VolumeTotal(v) => FormattedTag::new("Volume Total", v.to_string()),
        StandardTag::Work(v) => FormattedTag::new("Work", &**v),
        StandardTag::Writer(v) => FormattedTag::new("Writer", &**v),
        StandardTag::WrittenDate(v) => FormattedTag::new("Written Date", &**v),
